 ...
 *
 *   before           identity table, no fast-reply cap, no anticipatory hover   → holdout and fit
...
const RUNS: Run[] = [
	{ name: "before-holdout", table: "identity", production: false, split: "holdout" },
	{ name: "before-fit", table: "identity", production: false, split: "fit" },
